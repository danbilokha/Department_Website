  ...
  return (
    <div id="main">
      ...
      <article>
                ...
                <p>
                Науково-дослідна практика  є важливим елементом науково-дослідної роботи магістрів в плані опрацювання прикладної та
                 експериментальної частини  їх дисертаційної роботи, реалізації їх ідей, досліджень, отриманих результатів  на практиці 
                 та становленню їх як кваліфікованих працівників в сфері телекомунікацій. Вона є складовою частиною навчального плану підготовки 
                 магістрів на завершальному етапі їх роботи над магістерською дисертацією, а саме в 4 семестрі.  Науково-дослідна практика проводиться
                  згідно "Методичних рекомендацій по складанню програм практики студентів вищих навчальних закладів України" та навчального плану за 
                  спеціальністю 8.05090301 «Інформаційні мережі зв’язку».
                </p>

                <p>
                Метою практики є ознайомлення з основними видами робіт, що передбачені умовами  щодо складання ТЗ з НДР при проектуванні нових 
                чи модернізації  існуючих розподілених інформаційних систем, розробці програмного забезпечення телекомунікаційних систем та інше.
                </p>
      </article>
