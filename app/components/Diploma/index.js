    ...
    <>
      <div className="container_image_and_text_TUD">                
        <div className = "container_text_TUD">
          ...
          <p>Студенти НТУУ «КПІ» мають можливість навчатися по програмам магістратури НТУУ «КПІ» «Інформаційні мережі зв’язку» у поєднанні з програмою магістратури ТУД «Інженерія розподілених систем» (Distributed Systems Engineering) для отримання другої вищої освіти. Формування та підготовка груп студентів починається з другого року їх навчання в НТУУ «КПІ» за результатами завершення першого року навчання. Докладніше читайте <a href="http://its.kpi.ua/Pages/default.aspx?section=doublemaster">тут</a></p>
